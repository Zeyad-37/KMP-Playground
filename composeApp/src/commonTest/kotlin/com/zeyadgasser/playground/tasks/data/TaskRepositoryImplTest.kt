...
class TaskRepositoryImplTest {
    ...
    private val databaseTestDriverFactory: PlaygroundDB = PlaygroundDB(DatabaseTestDriverFactory.createDriver())
    private val fakeDatabase = PlaygroundDAO(databaseTestDriverFactory, StandardTestDispatcher())
