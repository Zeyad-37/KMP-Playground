...
sharedLib.xcfName = "badHabitsListKit"

kotlin {
    androidLibrary {
        namespace = "com.zeyadgasser.playground.badhabits.list"
    }
...
//    publicResClass = false
    packageOfResClass = "com.zeyadgasser.playground.badhabits.list.resources"
